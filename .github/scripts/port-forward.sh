...
kubectl port-forward --address 127.0.0.1 svc/veraid-authority-poweb 8080:8082 &
kubectl port-forward --address 127.0.0.1 svc/veraid-authority-pohttp 8081:80 &
kubectl port-forward --address 127.0.0.1 svc/veraid-authority-cogrpc 8082:8081 &
