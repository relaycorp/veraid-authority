export enum OrgProblem {
  ...
  INVALID_ORG_NAME = 'https://veraid.net/problems/invalid-org-name',
  EXISTING_MEMBERS = 'https://veraid.net/problems/existing-members',
  LAST_MEMBER_NOT_ADMIN = 'https://veraid.net/problems/last-member-not-admin',
}
